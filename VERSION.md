...
| 406 | `(эта сборка)` | патч | **23.0.1** | перепись параметров нашла три неразмеченные строки держателя, а перепись семейств — что их стало семь: Ø катушки не нужен кронштейну, ширина не нужна роликам и стойке, и обе строки показывались там, где ни на что не влияют |
