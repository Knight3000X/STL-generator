...
| 354 | `(эта сборка)` | патч | **18.26.1** | шаг и перемычка узора стали ручками листа; крупный шаг молча отключал решётку; из набора и плиты строилась одна модель, остальные шли пустыми |
