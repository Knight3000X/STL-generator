...
Таких коммитов в истории шесть, и они двух разных сортов.
...
**`798f027`, `0aa7a39`, `f658c57`, `af9a014`, `5de9a4a`** — разбор присланных образцов: оснастка в
...
| 333 | `(эта сборка)` | минорный | **18.8.0** | тяжёлый импорт: предпросмотр упрощается, экспорт идёт полной сеткой |
