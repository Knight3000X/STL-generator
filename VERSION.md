...
| 417 | `(эта сборка)` | минорный | **24.3.0** | системы заговорили друг с другом: у настенного органайзера появились лицевые ПЕРЕХОДНИКИ — рейка французской планки и полка Gridfinity. Сзади любая из трёх систем, спереди другая, отдельной формы под каждую пару не нужно. Клин рейки не подобран, а выведен из ответного задника поворотом на пол-оборота: подобранный на глаз сошёлся бы только при одном вылете зацепа |
