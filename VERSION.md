...
| 421 | `(эта сборка)` | минорный | **24.7.0** | цепочка на шаровых замках, печать в сборе: змейка, браслет, гусиная шея. Тело звена дважды стояло не там: сперва заполняло полость чашки (звенья спекались, а сетка оставалась герметичной), потом попадало в полосу оболочки и упиралось в кромку устья на семи градусах вместо заявленных тридцати двух — число печаталось в предупреждении, а проверить его было нечем |
