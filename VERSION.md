...
| 352 | `(эта сборка)` | минорный | **18.25.0** | энергоцепь: звенья россыпью, радиус изгиба выведен в зазор между перемычками; листу добавлены четыре узора, а сквозная решётка с текстурным узором перестала молча подменяться ромбом |
