...
| 374 | `(эта сборка)` | патч | **18.37.1** | цвет и место терялись посередине пути: чистка пересобирала деталь из пары полей, а место из координат не переезжало в смещение записи |
