...
| 387 | `(эта сборка)` | минорный | **21.1.0** | узор шара задан непрерывным полем: лесенка на наклонных перемычках исчезла, ширина перестала квантоваться, у спирали она мерилась вдоль параллели |
