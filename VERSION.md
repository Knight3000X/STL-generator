...
| 401 | `(эта сборка)` | минорный | **22.8.0** | арабские цифры на циферблате и римская четвёрка на выбор: по умолчанию IV, а IIII — по заказу; засечки стали свойством набора, и правило их подавления смотрит на всю перекладину, а не на её концы |
