...
| 369 | `(эта сборка)` | патч | **18.33.4** | вычитка: три молчащих отказа названы словом (цвет, которого нет; надпись, срезанная отступом; вмятина глубже текстуры), плюс расхождения замеров с текстом |
