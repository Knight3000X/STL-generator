...
| 408 | `(эта сборка)` | минорный | **23.2.0** | раскладка по столу: габарит стола читается из того же шаблона проекта Orca, что и палитра филамента, упаковка полками по убыванию глубины, а не влезшее остаётся где было и названо числом |
