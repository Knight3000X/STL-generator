...
| 420 | `(эта сборка)` | минорный | **24.6.0** | зажим для пакета: держит не форма, а упругость, и считается он той же консольной формулой, что защёлка и язычок футляра — усилие E·w·t³·δ/(4L³), деформация у корня 1.5·δ·t/L². Спинка полукруглая: прямой внутренний угол — концентратор, а скруглить его нечем, просвет шесть десятых миллиметра |
