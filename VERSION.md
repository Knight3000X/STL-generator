...
| 390 | `(эта сборка)` | минорный | **22.1.0** | всё панно одной кнопкой: плитки раскладываются отдельными моделями сборки, номера раздаются построителем, а не набираются руками |
