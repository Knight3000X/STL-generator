...
| 363 | `(эта сборка)` | патч | **18.32.2** | на мелком шаге узоры вырождались: перемычка ужимается по клетке, детализация плавных мерится узором, змеиная кожа стала плотнее |
