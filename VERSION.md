...
| 399 | `(эта сборка)` | патч | **22.6.1** | принадлежность шейки верхней половине не проверялась, а два шаблона мутаций устарели: строка расчёта радиуса встречается дважды, по проходу подбора |
