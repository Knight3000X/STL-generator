...
| 404 | `(эта сборка)` | патч | **22.10.1** | батарея поймала промежуточный коммит без строки в реестре: снимок работы, сделанный ради сохранности при откатах контейнера, назван исключением поимённо и с причиной |
