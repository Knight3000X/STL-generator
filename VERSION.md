...
Таких коммитов в истории семь, и они двух разных сортов.
...
| 339 | `(эта сборка)` | минорный | **18.14.0** | вводы под проводку на электрокорпусе, раскладка по граням как у вентиляции |
