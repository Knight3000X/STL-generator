...
| 419 | `(эта сборка)` | минорный | **24.5.0** | сито-лейка на бутылку: перфорированный диск поперёк горла крышки. Число дырок в кольце считается по ХОРДЕ, а не по дуге — дуга длиннее, и просвет выходил на восемь сотых меньше заказанного. Кольца растягиваются на весь радиус: отсчёт шагом от центра давал скачок с семи дырок на девятнадцать от миллиметра резьбы |
