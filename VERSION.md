...
| 396 | `(эта сборка)` | минорный | **22.5.0** | посадка абажура переделана: не хомут сверху, схлопывающий устье, а крестовина у основания — она ложится на стол первым слоем и силуэт не трогает вовсе |
