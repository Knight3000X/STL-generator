...
| 405 | `(эта сборка)` | мажорный | **23.0.0** | двадцать третья базовая форма: держатель катушки филамента — роликовый блок на подшипниках 608, стойка под пруток, настенный кронштейн. Первая деталь в наборе, которая обслуживает не изделие, а сам принтер |
