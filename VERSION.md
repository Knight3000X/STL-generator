...
| 350 | `(эта сборка)` | минорный | **18.23.0** | восемь новых текстур граней (четыре плавные, со ступенчатым рельефом); у гребёнки переставлены два отверстия, а не деталь целиком |
