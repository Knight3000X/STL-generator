...
| 389 | `(эта сборка)` | мажорный | **22.0.0** | двадцать вторая базовая форма: настенные часы — пластина строится ячейками в полярных координатах, метки стоят отдельными телами под одну смену цвета |
