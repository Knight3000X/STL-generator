...
| 394 | `(эта сборка)` | минорный | **22.4.0** | шейка под шнур у шара: ёлочному шарику нужна дырочка, а не горловина, а горловина у шара выводится из толщины и уже минимума не бывает |
