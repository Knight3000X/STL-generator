...
| 310 | `(эта сборка)` | патч | **17.7.1** | промятая крышка корпуса теряла три отверстия из четырёх и зенковку; кольцо подстаканника отсчитывается от края детали, а не от борта |
