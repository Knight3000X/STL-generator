...
Таких коммитов в истории восемь, и они двух разных сортов.
...
| 403 | `(эта сборка)` | минорный | **22.10.0** | граммы по слотам в палитре сборки: было видно, КАКИЕ цвета нужны, стало — и сколько каждого; у раскрашенной детали доля считается по площади, потому что своего объёма у покраски нет |
