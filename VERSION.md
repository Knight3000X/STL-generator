...
| 423 | `(эта сборка)` | минорный | **24.8.0** | зажим для пакета переделан в ПРИЩЕПКУ: две губки на живом шарнире, застёгнутые крючком в прорезь. Конструкцию первой версии — U-образную пружину — я выбрал сам, а заказана была прищепка. Пакет ложится ближе к шарниру, и усилие на нём выводится из равенства моментов; длина крючка не назначается, а считается из допустимой деформации материала |
