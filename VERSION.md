...
| 415 | `(эта сборка)` | минорный | **24.1.0** | виброножка: гасит не мягкость, а собственная частота системы, и она считается — жёсткость талии, осадка под нагрузкой, f₀ и частота, выше которой опора работает, а ниже усиливает. Главной ручкой оказалось заполнение, а не материал: жёсткость ячеистого тела падает как КВАДРАТ заполнения, и сплошная ножка на умолчаниях изолировала только выше 80 Гц, то есть не работала |
