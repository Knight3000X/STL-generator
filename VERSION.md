...
| 360 | `(эта сборка)` | минорный | **18.31.0** | накидная гайка ввода: купол вместо шестигранной тумбы, под ключ остаётся резьбовая часть; лепестков цанги до 24 с замером ширины; футляр развёрнут — петля на заднюю стенку |
