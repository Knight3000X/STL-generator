...
| 329 | `(эта сборка)` | минорный | **18.5.0** | раздел «Тесты» переписан целиком: десять образцов вместо шести — линейка, скругления, фаски, нависания, мосты, купола, посадка, башня, размеры, стенки |
