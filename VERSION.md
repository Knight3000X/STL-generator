...
| 392 | `(эта сборка)` | минорный | **22.2.0** | абажур садится на патрон: верхнее отверстие стало хомутом под кольцо E27/E14, огранка и рельеф на нём выключены — оба только убавляют радиус |
