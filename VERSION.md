...
| 411 | `(эта сборка)` | минорный | **23.5.0** | струбцина: скоба под свои же болт и гайку. Имя clampW оказалось занято хомутом, и спецификация молча читала его ширину; детектор совпадающих граней по серединной точке не видел наложения узкой полосой |
