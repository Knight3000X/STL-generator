...
| 386 | `(эта сборка)` | патч | **21.0.2** | проушина стояла вверх ногами: прорезь идёт ВВЕРХ от окружности, иначе рамка съезжает с гвоздя тем же движением, каким её вешали |
