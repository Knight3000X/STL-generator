...
| 359 | `(эта сборка)` | минорный | **18.30.0** | логотипы на футляре: наружные плиты обеих деталей мнутся сами, «верх» — это крышка; змеиная кожа как узор листа и как текстура грани |
