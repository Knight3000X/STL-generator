...
| 409 | `(эта сборка)` | минорный | **23.3.0** | кондуктор для сверления: в наборе было чем мерить и нечем разметить. Минимальный шаг и густота сетки получены перебором — построитель плиты выбрасывал отверстия молча, и из двенадцати оставалось семь |
