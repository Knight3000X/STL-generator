...
| 407 | `(эта сборка)` | минорный | **23.1.0** | стрелки к своему циферблату: длины выводятся из его диаметра, отверстия задаются («0 = ходовое»), форма — выпуклая оболочка трёх окружностей. Часы стали семейством с двумя разновидностями |
