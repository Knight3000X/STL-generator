...
| 382 | `(эта сборка)` | мажорный | **19.0.0** | девятнадцатая базовая форма: рамка для фото — багет протянут по замкнутому контуру, размеры выведены из снимка; задник с проушиной |
