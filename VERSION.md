...
| 416 | `(эта сборка)` | минорный | **24.2.0** | манжета в крышку банки: печатная резьба не герметична сама по себе — витки ложатся слоями, между слоями капилляры. Радиус канавки не задаётся, а следует из банки: середина торца горла. Канавке быть шире торца можно и нужно, а кольцу нельзя — это разные требования. Пара стала цепочкой из трёх: крышка → манжета → банка → крышка |
