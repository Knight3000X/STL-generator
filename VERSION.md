...
| 395 | `(эта сборка)` | патч | **22.4.1** | мутации нашли четыре дыры в проверке шейки: высота сверялась сама с собой, центрирование не проверялось вовсе, толщина подошвы не утверждалась, а отказной набор попадал не в тот сторож |
