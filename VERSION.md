...
| 397 | `(эта сборка)` | патч | **22.5.1** | потолок угла луча крестовины не проверялся: без него лучи смыкаются в сплошной диск, и это случается в 1898 наборах из 22 638 |
