...
for t in test_paramrows.js test_wormwheel.js test_vase.js test_keycap.js test_slice.js test_thread.js test_gear.js test_drilljig.js \
          ...
          test_gridfinity.js test_hook.js test_hexshelf.js test_clips.js test_hole_patterns.js test_hinge.js test_print_check.js test_wallorg.js test_toolrack.js \
