...
for t in test_paramrows.js test_wormwheel.js test_vase.js test_keycap.js test_slice.js test_thread.js test_gear.js \
          test_frame.js test_tile.js test_ball.js test_clock.js test_lampshade.js test_ballneck.js test_ballsplit.js test_battery.js test_hook_styles.js test_funnel.js test_squircle.js test_poly.js test_funnel_cap.js test_winding.js \
