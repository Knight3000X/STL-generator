...
for t in test_paramrows.js test_wormwheel.js test_vase.js test_keycap.js test_slice.js test_thread.js test_gear.js test_drilljig.js \
          ...
          test_svg_hole.js test_baseplate.js test_import.js test_3mf.js test_palette.js test_arrange.js test_gclamp.js test_material.js test_seal.js test_cardholder.js test_registry.js; do
