/* Service worker for the STL generator PWA.
   ...
   значило «свежая сборка доезжает сама». На деле, на телефоне по LTE, это значит две с половиной сотни
   килобайт… то есть два с половиной МЕГАбайта на каждый запуск, десять-пятнадцать секунд заставки. А
...
const CACHE_VERSION = 'stl-gen-v18.32.3';   // bump together with APP_VERSION and version.json
const SHELL = [
  './',
  'index.html',
