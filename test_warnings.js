...
//
// ЧТО ОСТАЛОСЬ МОЛЧАТЬ (49 мест на v25.25.0) — по разбору это три разных случая, и ни один из них не
...
const COVER = {trip:0, faces:new Set(), dieHm:0, ams:0, mate:0};
...
console.log('\n=== перепись мёртвых предупреждений ===');
{
  ...
  const FIRED_MIN = 445, DEAD_MAX = 49;   // v25.20.0 → v25.22.0 → v25.25.0 → v25.26.0 (494 места)
